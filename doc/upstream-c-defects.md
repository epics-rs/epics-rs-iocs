...
| 224 | `drvMultiFunction.cpp:1653-1654` — the user-waveform amplitude/offset are read at the span index `i` instead of the channel `k` | fixed-in-port (the user waveform takes the absolute channel's Amplitude/Offset, `port-parity-defects.md` PP-94) |
