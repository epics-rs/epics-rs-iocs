...
dbLoadRecords("$(GM10)/db/gm10_system.template", "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE)")
...
dbLoadRecords("$(GM10)/db/gm10_analog_input.template",  "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=1")
dbLoadRecords("$(GM10)/db/gm10_analog_input.template",  "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=2")
dbLoadRecords("$(GM10)/db/gm10_digital_input.template", "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=101")
dbLoadRecords("$(GM10)/db/gm10_digital_output.template","P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=201")
dbLoadRecords("$(GM10)/db/gm10_pulse_input.template",   "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=301")
dbLoadRecords("$(GM10)/db/gm10_analog_output.template", "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=401")
dbLoadRecords("$(GM10)/db/gm10_calculation.template",   "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=A1")
dbLoadRecords("$(GM10)/db/gm10_communication.template", "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=C1")
dbLoadRecords("$(GM10)/db/gm10_constant.template",      "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=K1")
dbLoadRecords("$(GM10)/db/gm10_varconstant.template",   "P=$(P),DAU=$(DAU),HANDLE=$(HANDLE),ADDRESS=W1")
