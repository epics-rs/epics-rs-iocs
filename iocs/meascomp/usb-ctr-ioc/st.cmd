...
# Digital I/O bit directions (0=input, 1=output); bits 0-3 in, 4-7 out as in
# upstream USBCTR.substitutions.
...
dbLoadRecords("$(SCALER)/db/scaler.db", "P=$(PREFIX),S=scaler1,DTYP=Asyn Scaler,OUT=@asyn($(PORT)),FREQ=10000000")
